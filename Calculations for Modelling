# NOTE: As you come across new variables, please enter them at the top of the document in some sort of alphabetical order
# and comment them out. This will make each equation neater, and thus the whole document more readable. In some cases, a 
# subscript may accompany an already defined variable, for now define it as a seperate variable. We can discuss later
...
# Inlet/Exit Modelling - Matthew Weippert
  ...
  # Mattingly 6-4: Isentropic Efficiency of Diffusor
    ...
    eta_d =approx= (T_t2s - T_0)/(T_t0 - T_0)
